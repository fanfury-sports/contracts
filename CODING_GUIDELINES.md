...
- Setup a task runner. _Cargo make_ is recommended. Here’s an example: [https://github.com/fanfury-sports/rover/blob/master/Makefile.toml](https://github.com/fanfury-sports/rover/blob/master/Makefile.toml). Tasks to test for:
  - Building
  - Linting
  - Formatting
  - Testing
...
- Setup Github workflow that runs all checks when pull requests are open: [https://github.com/fanfury-sports/rover/blob/master/.github/workflows](https://github.com/fanfury-sports/rover/blob/master/.github/workflows).
