...
use fury_types::{adapters::red_bank::RedBank, credit_manager::V2Updates};
...
/// Taken from original Owner package version: https://github.com/fanfury-sports/owner/blob/e807c6b12511987577645c8bad68cc7bd6da5398/src/owner.rs#L158
pub mod v1_state {
