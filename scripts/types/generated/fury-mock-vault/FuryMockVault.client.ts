...
export interface FuryMockVaultReadOnlyInterface {
...
export class FuryMockVaultQueryClient implements FuryMockVaultReadOnlyInterface {
...
export interface FuryMockVaultInterface extends FuryMockVaultReadOnlyInterface {
  contractAddress: string
  sender: string
  deposit: (
    {
...
export class FuryMockVaultClient
  extends FuryMockVaultQueryClient
  implements FuryMockVaultInterface
{
