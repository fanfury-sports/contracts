...
export interface FuryOracleOsmosisReadOnlyInterface {
...
export class FuryOracleOsmosisQueryClient implements FuryOracleOsmosisReadOnlyInterface {
...
export interface FuryOracleOsmosisInterface extends FuryOracleOsmosisReadOnlyInterface {
  contractAddress: string
  sender: string
  setPriceSource: (
    {
...
export class FuryOracleOsmosisClient
  extends FuryOracleOsmosisQueryClient
  implements FuryOracleOsmosisInterface
{
