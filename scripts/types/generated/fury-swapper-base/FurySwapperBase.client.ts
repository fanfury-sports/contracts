...
export interface FurySwapperBaseReadOnlyInterface {
...
export class FurySwapperBaseQueryClient implements FurySwapperBaseReadOnlyInterface {
...
export interface FurySwapperBaseInterface extends FurySwapperBaseReadOnlyInterface {
  contractAddress: string
  sender: string
  updateOwner: (
...
export class FurySwapperBaseClient
  extends FurySwapperBaseQueryClient
  implements FurySwapperBaseInterface
{
