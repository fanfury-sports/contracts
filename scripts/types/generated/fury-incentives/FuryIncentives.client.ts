...
export interface FuryIncentivesReadOnlyInterface {
...
export class FuryIncentivesQueryClient implements FuryIncentivesReadOnlyInterface {
...
export interface FuryIncentivesInterface extends FuryIncentivesReadOnlyInterface {
  contractAddress: string
  sender: string
  updateWhitelist: (
    {
...
export class FuryIncentivesClient
  extends FuryIncentivesQueryClient
  implements FuryIncentivesInterface
{
