...
export interface FuryZapperBaseReadOnlyInterface {
...
export class FuryZapperBaseQueryClient implements FuryZapperBaseReadOnlyInterface {
...
export interface FuryZapperBaseInterface extends FuryZapperBaseReadOnlyInterface {
  contractAddress: string
  sender: string
  provideLiquidity: (
    {
...
export class FuryZapperBaseClient
  extends FuryZapperBaseQueryClient
  implements FuryZapperBaseInterface
{
