...
export interface FuryRewardsCollectorBaseReadOnlyInterface {
  contractAddress: string
  config: () => Promise<ConfigResponse>
}
export class FuryRewardsCollectorBaseQueryClient
  implements FuryRewardsCollectorBaseReadOnlyInterface
{
...
export interface FuryRewardsCollectorBaseInterface
  extends FuryRewardsCollectorBaseReadOnlyInterface {
  contractAddress: string
  sender: string
  updateOwner: (
...
export class FuryRewardsCollectorBaseClient
  extends FuryRewardsCollectorBaseQueryClient
  implements FuryRewardsCollectorBaseInterface
{
