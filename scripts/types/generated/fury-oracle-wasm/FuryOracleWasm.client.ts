...
export interface FuryOracleWasmReadOnlyInterface {
...
export class FuryOracleWasmQueryClient implements FuryOracleWasmReadOnlyInterface {
...
export interface FuryOracleWasmInterface extends FuryOracleWasmReadOnlyInterface {
  contractAddress: string
  sender: string
  setPriceSource: (
    {
...
export class FuryOracleWasmClient
  extends FuryOracleWasmQueryClient
  implements FuryOracleWasmInterface
{
