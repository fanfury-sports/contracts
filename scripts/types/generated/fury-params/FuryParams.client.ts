...
export interface FuryParamsReadOnlyInterface {
...
export class FuryParamsQueryClient implements FuryParamsReadOnlyInterface {
...
export interface FuryParamsInterface extends FuryParamsReadOnlyInterface {
  contractAddress: string
  sender: string
  updateOwner: (
...
export class FuryParamsClient extends FuryParamsQueryClient implements FuryParamsInterface {
