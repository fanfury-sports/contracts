...
export interface FuryAccountNftReadOnlyInterface {
...
export class FuryAccountNftQueryClient implements FuryAccountNftReadOnlyInterface {
...
export interface FuryAccountNftInterface extends FuryAccountNftReadOnlyInterface {
  contractAddress: string
  sender: string
  updateConfig: (
    {
...
export class FuryAccountNftClient
  extends FuryAccountNftQueryClient
  implements FuryAccountNftInterface
{
