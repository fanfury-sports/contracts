...
export interface FuryRedBankReadOnlyInterface {
...
export class FuryRedBankQueryClient implements FuryRedBankReadOnlyInterface {
...
export interface FuryRedBankInterface extends FuryRedBankReadOnlyInterface {
  contractAddress: string
  sender: string
  updateOwner: (
...
export class FuryRedBankClient extends FuryRedBankQueryClient implements FuryRedBankInterface {
