...
use fury_oracle_osmosis::DowntimeDetector;
use fury_types::{address_provider, incentives, oracle, params::AssetParams, red_bank};
...
impl Querier for FuryMockQuerier {
    ...
    pub fn handle_query(&self, request: &QueryRequest<Empty>) -> QuerierResult {
        match &request {
            QueryRequest::Wasm(WasmQuery::Smart {
                ...
                // Params Queries
                if let Ok(params_query) = from_binary::<fury_types::params::QueryMsg>(msg) {
